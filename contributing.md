# Contributing to format-people

First and foremost, thank you! We appreciate that you want to contribute to format-people, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for format-people**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for format-people:

- star the [project](https://github.com/doowb/format-people)
- tweet your support for format-people
...
- **version**: please note the version of format-people are you using
...
[so]: http://stackoverflow.com/questions/tagged/format-people